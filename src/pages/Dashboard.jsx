...
export const Dashboard = () => {
  ...
  return (
    <div className="space-y-7 md:space-y-9">
      <section className="relative isolate overflow-hidden rounded-[28px] border border-white/[0.075] bg-gradient-to-br from-[#151622]/95 via-[#101117]/80 to-[#101a19]/90 p-6 sm:p-8 lg:p-10 shadow-[0_25px_90px_-55px_rgba(99,102,241,0.45)]">
        ...
        <div className="flex flex-col gap-7 xl:flex-row xl:items-end xl:justify-between">
          <div className="max-w-2xl">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-emerald-400/15 bg-emerald-400/[0.06] px-3 py-1.5 text-[11px] font-semibold tracking-wide text-emerald-300">
            ...
            <h1 className="text-3xl font-semibold tracking-tight text-white sm:text-4xl lg:text-[2.8rem]">
              ...
              <span className="mt-1 block bg-gradient-to-r from-white via-zinc-200 to-zinc-500 bg-clip-text text-transparent">Money, in good hands.</span>
            </h1>
          ...
          <div className="flex items-center gap-3 self-start rounded-2xl border border-white/[0.07] bg-black/20 px-4 py-3 xl:self-auto">
            <div className="grid h-10 w-10 place-items-center rounded-xl border border-indigo-400/15 bg-indigo-400/10 text-indigo-300"><Activity className="h-5 w-5" /></div>
            <div><p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-zinc-500">Account</p><p className="mt-0.5 text-sm font-medium text-zinc-200">{profile.accountType}</p></div>
            <ArrowUpRight className="ml-3 h-4 w-4 text-zinc-600" />
          </div>
        </div>
      </section>
